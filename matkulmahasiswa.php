                    ...
                    <?php while ($data = mysqli_fetch_assoc($result)) { ?>
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-title">Mata Kuliah <?php echo $no++ ?> KELAS <?php echo $data['kelasampu']; ?></h5>
                            </div>
                            <div class="card-body">
                                <p class="card-text"><?php echo $data['matakuliahampu']; ?></p>
                                <p>Dosen Pengampu : <?php echo $data['namalengkap']; ?> </p>
                                <a href="setwpw.php" class="btn btn-danger"><i class="fas fa-eye"></i> Lihat Materi</a>
