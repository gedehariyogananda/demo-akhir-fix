...
// Ambil data usermahasiswa
$query2 = "SELECT * FROM usermahasiswa";
$result2 = mysqli_query($koneksi, $query2);
$data2 = mysqli_fetch_assoc($result2);

// Ambil data userdosen
$queryy = "SELECT * FROM userdosen";
$data = mysqli_query($koneksi, $queryy);
$dataakhir = mysqli_fetch_assoc($data);
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 content">
                <div class="col-md-9">
                    <form method="post" action="wpwinsert2.php">
                        <div class="mb-3">
                            <label for="judulTugas" class="form-label">Judul Tugas</label>
                            <input type="hidden" name="id_mahasiswa" value="<?php echo $data2['id_mahasiswa']; ?>" class="form-control">
                            <input type="hidden" name="id_dosen" value="<?php echo $dataakhir['id_dosen']; ?>" class="form-control">
                            <input type="text" name="judul" class="form-control" id="judulTugas">
                        </div>
                        <div class="mb-3">
                            <label for="deskripsiTugas" class="form-label">Deskripsi Tugas</label>
                            <textarea class="form-control" name="deskripsi" id="deskripsiTugas" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Deadline</label>
                            <input type="date" name="deadline" class="form-control">
                        </div>
                        <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Buat Tugas</button>
