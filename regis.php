...
function registrasi($data)
{
    ...
    $usernameUser = mysqli_query($koneksi, "SELECT username FROM userdosen WHERE username ='$username'");
    ...
    mysqli_query($koneksi, "INSERT INTO userdosen VALUES('', '$username', '$password')");
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST["register"])) {
                            if (registrasi($_POST) > 0) {
                                echo "<script>alert('akun telah berhasil didaftarkan');window.location = 'login.php';</script>";
                            } else {
                        ...
                        <form action="" method="post">
                            ...
                            <br>
                            <button style="width: 100%;" name="register" type="submit" class="btn btn-info">Register!</button>
                            <hr>
